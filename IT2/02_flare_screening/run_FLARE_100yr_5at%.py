"""
FLARE responses at 100-year decay time — CHUNKED version for SLURM array jobs.
...
flareFile/100yr/. After all chunks complete, run stitch_flare.py to merge
...
OUT_FILENAME = "flare_responses_5at_2y_irr-100yr_dec-over_spect"
CHUNK_DIR    = Path("FlareFiles/100yr")

# 100-year decay (1.0e+02 years), 8e13 flux, 2 year irradiation
FILTER_CRITERIA = {
    "Flux":     "8.000E+13",
    "Irr_time": "2.000E+00",
    "Dec_time": "1.000E+02",
