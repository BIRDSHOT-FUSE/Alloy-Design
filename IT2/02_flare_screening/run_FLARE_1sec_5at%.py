"""
FLARE responses at 1-second decay time — CHUNKED version for SLURM array jobs.
...
flareFile/1sec/. After all chunks complete, run stitch_flare.py to merge
...
OUT_FILENAME = "flare_responses_5at_2y_irr-1sec_dec-over_spect"
CHUNK_DIR    = Path("FlareFiles/1sec")

# 1-second decay (3.169e-08 years), 8e13 flux, 2 year irradiation
FILTER_CRITERIA = {
    "Flux":     "8.000E+13",
    "Irr_time": "2.000E+00",
    "Dec_time": "3.169E-08",
